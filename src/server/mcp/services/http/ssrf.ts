 ...
 * Idempotent - call once during startup (ensureRegistryLoaded covers every
 * entry point) instead of relying on module-import side effects, so
 * initialization order stays explicit and deterministic.
 */
export function installSsrfGuard(): void {
