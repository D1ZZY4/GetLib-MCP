import { CHARS_PER_TOKEN, DEFAULT_TOKEN_LIMIT } from "../constants";
import { tokenize } from "./tokenize";
import { parseSections, buildTokenCache, type Section } from "./sections";
import { bm25Score, buildIDF } from "./bm25";

// Re-exported so every existing `from "../utils/extract"` import keeps working.
export { tokenize, tokenVariants, expandTopicTokens, substantiveTokens } from "./tokenize";
export { parseMajor, sliceVersionBand } from "./version-band";
