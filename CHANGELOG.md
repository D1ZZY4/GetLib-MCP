...
<details>
<summary>1.5.2 changes (click to expand)</summary>
...
<details>
<summary>1.3.1 changes (click to expand)</summary>
...
- Make settings functional: preferences gains a working
  light/dark/system theme radio, and account shows the live
  session with sign out (or sign in) instead of status text alone.
...
<details>
<summary>1.2.8 changes (click to expand)</summary>
...
<details>
<summary>1.2.7 changes (click to expand)</summary>
...
- Keep validated code fragments through the examples pipeline and
  fall back honestly when file matches carry no usable code.
...
<details>
<summary>1.2.6 changes (click to expand)</summary>

### Fixed

- Count install, installation, and installing as the same topic
  vocabulary so setup guides pass the evidence gate.
...
<details>
<summary>1.2.5 changes (click to expand)</summary>
...
<details>
<summary>1.2.4 changes (click to expand)</summary>
...
<details>
<summary>1.2.1 changes (click to expand)</summary>
...
- Fail closed when the auth probe is unreachable, enforce
  blocked libraries in every resolver, and move dev mutations
  to the strict tier.
- Keep previews out of production policy, warn on shadowed URLs
  and accidental open production, retry failed init, and observe
  unexpected hosts without enforcing.
...
- Polish README route wording and configuration boundary docs.
- Rewrite the boundary checker implementation.
...
<details>
<summary>1.1.6 changes (click to expand)</summary>
